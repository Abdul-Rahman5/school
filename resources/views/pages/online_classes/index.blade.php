            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{url('OnlineClassesCreate')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">اضافة حصة اونلاين</a>
                                {{-- <a href="{{url('OnlineClassesCreate')}}" class="btn btn-warning btn-sm" role="button"
                                   aria-pressed="true">اضافة حصة اوف لاين</a> --}}
                                   <br><br>
