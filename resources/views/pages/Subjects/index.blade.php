            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{ url('SubjectCreate') }}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($subjects as $subject)
                                            ...
                                            <td>{{$subject->teacher->Name}}</td>
                                                <td>
                                                    <a href="{{ url("SubjectEdit/$subject->id") }}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="modal fade" id="delete_subject{{$subject->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{ url('SubjectDelete') }}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
