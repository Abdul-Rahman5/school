...
<div class="col-xl-12 mb-30">
    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            @endif
            @if (session()->has("successfly"))
            <div class="alert alert-success" role="alert">
            {{session()->get('successfly')}}
            </div>
            ...
            <br><br>
                ...
                <form action="{{url("fillterClasses")}}" method="get">
                    {{ csrf_field() }}
...
{{--
                    @else
                             <?php $myClass = $My_Classes; ?> --}}
                    @endif

                        <?php $i = 0; ?>

                        @foreach ($myClass as $My_Class)
                            <tr>
                                <?php $i++; ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- edit_form -->
                                            <form action="{{url("updateClassrooms")}}" method="post">
                                                {{ method_field('put') }}
                                                @csrf
                                                <div class="row">
                                                    <div class="col">
                            ...
                            <div class="modal fade" id="delete{{ $My_Class->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{url("deleteClassrooms")}}"
                                                  method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{url('storeClassrooms')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="repeater">
