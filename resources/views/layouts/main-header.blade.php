    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
               ...
               <form action="{{ url('logout/student') }}" method="get">
                   @elseif (auth('teacher')->check())
                   <form action="{{ url('logout/teacher') }}" method="get">
                   {{-- @elseif (auth('parent')->check())
                   <form action="logout/parent" method="get"> --}}

                    @else
                    <form action="{{ url('logout/web') }}" method="GET">
                        @csrf
                    @endif
